...
for epoch in range(num_epochs):
    ...
    np.save("../data/cnn_dilated_losses",np.array(losses))
    torch.save(model.state_dict(), '../data/cnn_dilated_extralayer_dilated.pkl')
...
def test(model):
    ...
    with open("../data/cnn_predictions_extralayer_dilated.csv", "w") as f:
        writer = csv.writer(f)
