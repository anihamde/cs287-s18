...
parser = argparse.ArgumentParser(description='gru training runner')
parser.add_argument('--model_file','-m',type=str,default='../../models/HW2/gru.pkl',help='Model save target.')
parser.add_argument('--batch_size','-bs',type=int,default=10,help='set training batch size. default=10.')
parser.add_argument('--num_layers','-nl',type=int,default=2,help='set number of gru layers.')
...
if not args.skip_training:
    ...
    for i in range(num_epochs):
        ...
        np.save("../../models/HW2/gru_losses",np.array(losses))
...
model.eval()
with open("gru_predictions.csv", "w") as f:
    writer = csv.writer(f)
