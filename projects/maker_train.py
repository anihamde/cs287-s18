...
parser.add_argument('--model_dict','-md',type=str,help='YAML file where model hyperparams are saved')
...
model_dict = yaml.safe_load(open(args.model_dict,'r'))
...
if args.model_type == 0:
    ...
    model = BassetNormCat(model_dict)
