...
parser.add_argument('--learning_rate1','-lr1',type=float,default=0.001,help='Learning rate for theta')
parser.add_argument('--learning_rate2','-lr2',type=float,default=0.001,help='Learning rate for lambda')
